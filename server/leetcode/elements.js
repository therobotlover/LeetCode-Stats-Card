  ...
  return new Item("svg", {
    ...
    children: [
      ...
      new Item("style", {
        id: "default-colors",
        content:
          "svg{opacity:0}:root{--bg-0:#fff;--bg-1:#e5e5e5;--bg-2:#d3d3d3;--bg-3:#d3d3d3;--text-0:#000;--text-1:#808080;--text-2:#808080;--text-3:#808080;--color-0:#ffa116;--color-1:#5cb85c;--color-2:#f0ad4e;--color-3:#d9534f;--bar-text:#fff}",
      }),
      new Item("defs", {
        children: [
          new Item("linearGradient", {
            ...
            children: [
              ...
              new Item("stop", {
                attr: { offset: "55%", "stop-color": "rgba(255,255,255,0.12)" },
              }),
              new Item("stop", {
...
export function Username(username, site, width) {
...
export function Ranking(ranking, width) {
...
export function TotalSolved(total, solved, width) {
...
export function Solved(problem, width) {
  const barX = 40;
